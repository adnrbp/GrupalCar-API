    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_client', models.BooleanField(default=True, help_text='Help distinguish users and perform queries.Clients are the main type of user', verbose_name='client status')),
                ('is_verfied', models.BooleanField(default=False, help_text='Set to true when the user have verified its email address.', verbose_name='verified')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reputation', models.FloatField(default=5.0, help_text="User's reputation based on the trips taken and offered.")),
